...
\usepackage{animate} % Do animacji z klatek (zamiast bezpośrednio gif)
\usepackage{tikz}
...
\input{sections/02_podstawy.tex}
\input{sections/03_fizyka.tex}
\input{sections/04_misje.tex}
\input{sections/05_roje.tex}
\input{sections/06_podsumowanie.tex}
