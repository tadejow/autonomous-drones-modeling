...
sim_vehicle.py -v ArduCopter -I0 --sysid 1 -f quad -L Wroclaw --out 127.0.0.1:14550 &

# Dron 2 
sim_vehicle.py -v ArduCopter -I1 --sysid 2 -f quad -L Wroclaw --out 127.0.0.1:14560 &

# Dron 3
sim_vehicle.py -v ArduCopter -I2 --sysid 3 -f quad -L Wroclaw --out 127.0.0.1:14570 &
